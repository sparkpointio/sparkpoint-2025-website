export function About() {
  return (
    <section className=" md:max-w-[60%] p-6 md:px-20 py-12 md:py-20">
      <div className="container mx-auto grid gap-8">
        <div className="grid text-left gap-3">
          <h1 className="text-4xl font-bold text-left">
            About SparkPoint
            <br />
            Revitalized. Focused. AI-First.
          </h1>
          <p className="text-2xl">
            Founded in 2018, SparkPoint Technologies Inc is
            reimagining blockchain for the AI era. We empower
            individuals and busineses to launch AI-driven, blockchain-based solutions
        ...
        <p className="text-2xl">
          ...
          decentralized technologies, driving continous
