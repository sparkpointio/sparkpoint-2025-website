...
import mascotSparky from '@/lib/assets/Sparky 3D.png';
...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col lg:flex-row justify-center items-center text-left px-[1.5rem] md:px-16 lg:px-28 py-28 overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row w-full items-center justify-between">
        <div className="max-w-2xl flex-1">
          ...
          <p className="text-lg md:text-xl text-[#404662] dark:text-[#f0f2ff]  mb-10">
            Harness the power of AI in DeFi with Sparky, your bluebird co-pilot. Simplify yield strategies, grow your assets, and earn smarter all with safety, clarity, and ease.
          </p>
        ...
        <div className="flex flex-1 justify-end items-center">
          <Image
            ...
            width={400}
            height={400}
            className="object-contain drop-shadow-2xl size-56 md:w-72 md:h-72 lg:size-[40rem]"
          />
        </div>
      </div>
    </section>
